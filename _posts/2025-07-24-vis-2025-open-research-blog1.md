---
title: Open Research - Background and First Steps
description: first in a series of blog posts about moving towards more open/reproducible science methods in VIS
layout: blog-page
active_nav: Blog
authors: Gabriel Strain, Laura Garrison
author_contact: 
permalink: 
---
...
This blog post series is aimed at authors who want to get started with Open Science practices, but who are not sure how (or why). In the first blog, we will look at:
 ...
 - How can I get started? Are there low-barrier-to-entry ways that I can begin to change my workflow? (**hint:** *the answer is yes*)
...
[2] Colavizza, Giovanni, et al. "An analysis of the effects of sharing research data, code, and preprints on citations." Plos one 19.10 (2024): e0311493.

[3] Huang, Chun-Kai, et al. "Open access research outputs receive more diverse citations." Scientometrics 129.2 (2024): 825-845.
